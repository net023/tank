...
public class UserProjectModel extends Model<UserProjectModel> {
	...
	public Record getUserProjectDataByProjectId(int pid){
		return Db.findFirst("select t2.projectName,t1.completeTime,t1.fureShape,t1.jireScale,t1.jireType,t1.jireZone,t1.projectAddress,t1.projectType,t1.tankConfigure,t1.waterZone from project t1 LEFT JOIN userproject t2 ON t2.accessTag = t1.accessTag AND t2.codeId = t1.codeId WHERE t2.id = ?", pid);
	}
